                        ...
                        <form id="cruise-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="image-upload-container">
                                    ...
                                    <input type="file" id="cruise-cover-input" class="image-upload-input" accept="image/*">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>
                    ...
                    <form id="edit-person-form" onsubmit="window.settingsComponent.handlePersonForm(event)">
                        ...
                        <div class="form-group">
                            ...
                            <div class="image-upload-container">
                                ...
                                <input type="file" id="edit-person-photo-input" class="image-upload-input" accept="image/*">
                            </div>
                        </div>
                    ...
                    <form id="edit-drink-form" onsubmit="window.settingsComponent.handleDrinkForm(event)">
                        ...
                        <div class="form-group">
                            ...
                            <div class="image-upload-container">
                                ...
                                <input type="file" id="edit-drink-photo-input" class="image-upload-input" accept="image/*">
                            </div>
                        </div>
