                        ...
                        <form id="add-person-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="image-upload-container">
                                    ...
                                    <input type="file" id="person-photo-input" class="image-upload-input" accept="image/*" capture="environment">
                                </div>
                        ...
                        <form id="add-drink-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="image-upload-container">
                                    ...
                                    <input type="file" id="drink-photo-input" class="image-upload-input" accept="image/*" capture="environment">
                                </div>
                                <div class="emoji-selector">
                                    <label>Or choose an emoji:</label>
        ...
        return `
            <div class="photo-upload-section">
                ...
                <div class="image-upload-container">
                    ...
                    <input type="file" id="record-photo-input" class="image-upload-input" accept="image/*" capture="environment">
                </div>
            </div>
        `;
    }
